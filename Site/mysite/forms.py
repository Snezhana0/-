...
class UserForm(forms.Form):
    name=forms.CharField(label="Введите ответ:")
    fio=forms.CharField(label="Введите ответ:")
    otch = forms.CharField(label="Введите ответ:")
    age = forms.IntegerField(label="Введите ответ:")
    add = forms.CharField(label="Введите ответ:")
    email= forms.CharField(label="Введите ответ:")
